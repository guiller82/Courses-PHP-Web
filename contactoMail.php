...
if ($_POST['action'] == "send") {
	...
	$mail->FromName = "CursosyCapacitaciones.com Mensaje Contacto";
...
<table width="100%" border="0" >
  <tr>
    <td class='whitetable' align="left"><strong class="TtuloCursoInside">Formulario de contacto</strong></td>
...
<div >  
  <p><strong>CursosyCapacitaciones.com </strong>
    ...
    <strong>e-mail:</strong> info@cursosycapacitaciones.com <br />
    <br />
